					...
					<div class="widgetcontent bordered shadowed nopadding span7">
						<?php echo $this->Form->create('Affilliate', array('id'=>'registerAffilliates', 'class' => "stdform stdform2")); ?>
							...
							<h3 class="widgettitle nomargin shadowed"><span class=" iconsweets-users2"></span>&nbsp; Personal Data</h3>
								<p>
									<label>Status</label> 
									<span class="field"><select id="AffilliateStatus" class="validate[required] span5" name="data[Affilliate][status]">
										<option value="">-----</option>
								...
								<p>
									<label>Country</label>
									<span class="field"><select name="data[Affilliate][country]" id="AffilliateCountry" class="validate[required] span5">
										<option value="">-----</option>
