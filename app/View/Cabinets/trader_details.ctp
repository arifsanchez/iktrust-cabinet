					...
					<div class="widgetcontent bordered span5">
						<div class="span12 well">
							...
							<div class="btn-group pull-right">
								<button class="btn btn-danger dropdown-toggle btn-group pull-right" data-toggle="dropdown"><i class=" iconfa-paper-clip"></i> &nbsp; Action <span class="caret"></span></button>
								<ul class="dropdown-menu">
									...
									<li><?php echo $this->Html->link('<span class="iconfa-edit"></span> Change My Leverage',array('controller' => '', 'action' => '#'),array('escape' => false)); ?></li>   
