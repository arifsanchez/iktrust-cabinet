        ...
        <div class="maincontent">
        	<div class="contentinner content-dashboard">
            	<div class="alert alert-info">
                    ...
                    <strong>Welcome!</strong> Happy trading.
                </div><!--alert-->
                
                <div class="row-fluid">
                	<div class="span8">
                    	<ul class="widgeticons row-fluid">
                        	<li class="one_fifth"><a href="#"><img src="img/gemicon/archive.png" alt="" /><span>Go To Dashboard</span></a></li>
                            <li class="one_fifth"><a href="#"><img src="img/gemicon/users.png" alt="" /><span>Go To My Account</span></a></li>
                            <li class="one_fifth"><a href="#"><img src="img/gemicon/settings.png" alt="" /><span>Open Trading Account</span></a></li>
                            <li class="one_fifth"><a href="#"><img src="img/gemicon/notify.png" alt="" /><span>Open Demo Account</span></a></li>
                            <li class="one_fifth last"><a href="#"><img src="img/gemicon/reports.png" alt="" /><span>Launch MT4 Webtrader</span></a></li>
