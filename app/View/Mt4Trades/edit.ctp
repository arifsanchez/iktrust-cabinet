...
<?php echo $this->Form->create('Mt4Trade'); ?>
	<fieldset>
		<legend><?php echo __('Edit Mt4 Trade'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('Mt4Trade.id')), null, __('Are you sure you want to delete # %s?', $this->Form->value('Mt4Trade.id'))); ?></li>
