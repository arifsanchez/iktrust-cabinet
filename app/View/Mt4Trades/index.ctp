		...
		<div class="contentinner">
			...
			<div class="contentinnerscrollT">
				...
				<table class="table table-condensed">
					...
					<tr>
						...
						<td class="actions">
							<?php echo $this->Html->link(__('View'), array('action' => 'view', $mt4Trade['Mt4Trade']['LOGIN'])); ?>
							<?php echo $this->Html->link(__('Edit'), array('action' => 'edit', $mt4Trade['Mt4Trade']['LOGIN'])); ?>
							<?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $mt4Trade['Mt4Trade']['LOGIN']), null, __('Are you sure you want to delete # %s?', $mt4Trade['Mt4Trade']['LOGIN'])); ?>
						</td>
					</tr>
					<?php endforeach; ?>
				</table>
			...
			<br>
				<!--div class="actions">
					...
					<ul>
						<li><?php #echo $this->Html->btn(__('New Mt4 Trade'), array('action' => 'add')); ?></li>
					</ul>
				</div-->
			</div>
