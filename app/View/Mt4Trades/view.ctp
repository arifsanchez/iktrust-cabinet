...
<div class="actions">
	...
	<ul>
		<li><?php echo $this->Html->link(__('Edit Mt4 Trade'), array('action' => 'edit', $mt4Trade['Mt4Trade']['id'])); ?> </li>
		<li><?php echo $this->Form->postLink(__('Delete Mt4 Trade'), array('action' => 'delete', $mt4Trade['Mt4Trade']['id']), null, __('Are you sure you want to delete # %s?', $mt4Trade['Mt4Trade']['id'])); ?> </li>
