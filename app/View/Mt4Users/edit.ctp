...
<?php echo $this->Form->create('Mt4User'); ?>
	<fieldset>
		<legend><?php echo __('Edit Mt4 User'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('Mt4User.id')), null, __('Are you sure you want to delete # %s?', $this->Form->value('Mt4User.id'))); ?></li>
