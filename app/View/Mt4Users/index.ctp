...
<div class="maincontent">
	<div class="contentinner">
		...
		<div class="contentinnerscroll">
			<h3 class="widgettitle nomargin shadowed">Mt4 Users</h3>
				<table class="table table-condensed">
					...
					<tr>
						...
						<td class="actions">
							<?php echo $this->Html->link(__('View'), array('action' => 'view', $mt4User['Mt4User']['LOGIN'])); ?>
							<?php echo $this->Html->link(__('Edit'), array('action' => 'edit', $mt4User['Mt4User']['LOGIN'])); ?>
							<?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $mt4User['Mt4User']['LOGIN']), null, __('Are you sure you want to delete # %s?', $mt4User['Mt4User']['LOGIN'])); ?>
						</td>
					</tr>
				<?php endforeach; ?>
			</table>
